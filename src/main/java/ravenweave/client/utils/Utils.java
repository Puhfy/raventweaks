...
public class Utils {
            ...
            if ((entity != null) && (mc.theWorld != null)) {
                ...
                for (Entity entity1 : list) {
                    ...
                    if (axisalignedbb.isVecInside(vec3)) {
                        ...
                        if ((d3 < d2) || (d2 == 0.0D))
                            if ((entity1 == entity.ridingEntity) && !entity.canAttackWithItem()) {
                                if (d2 == 0.0D) {
                                    pointedEntity = entity1;
    ...
    public static class Client {
        ...
        public static net.minecraft.util.Timer getTimer() {
            return (net.minecraft.util.Timer) ReflectionUtils.getPrivateValue(Minecraft.class, Minecraft.getMinecraft(), "timer");
        }
